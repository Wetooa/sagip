    ...
    <div ref={searchRef} className="absolute top-4 left-4 z-10 w-80">
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2 pr-10 rounded-lg border border-gray-300 shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        />
        {loading && (
