...
export function CensusModal({ isOpen, onClose, onSubmit }: CensusModalProps) {
  const [step, setStep] = useState<"personal" | "family" | "review">(
    "personal",
  );
  ...
  const handleAddMember = () => {
    ...
    if (editingMemberId) {
      setFamilyMembers((prev) =>
        prev.map((m) =>
          m.id === editingMemberId ? { ...newMember, id: m.id } : m,
        ),
      );
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      handlePersonalChange("activeAddress", e.target.value)
                    }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handlePersonalChange("governmentIdType", e.target.value)
                  }
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handlePersonalChange("governmentId", e.target.value)
                    }
              ...
              <label className="flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl cursor-pointer hover:bg-white/[7%] transition-all">
                <input
                  ...
                  onChange={(e) =>
                    handlePersonalChange("willVolunteer", e.target.checked)
                  }
                ...
                <div className="space-y-3 p-4 bg-white/5 border border-white/10 rounded-xl">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setMemberForm((prev) => ({
                        ...prev,
                        medicalCondition: e.target.value as any,
                      }))
                    }
                    className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-[#0ea5e9] focus:border-transparent transition-all"
                  >
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium capitalize">
                      {personalInfo.governmentIdType.replace("_", " ")}
                    </p>
                  </div>
                  <div className="col-span-2">
                    <p className="text-gray-400 mb-1">Address</p>
                    <p className="text-white font-medium">
                      {personalInfo.activeAddress}
                    </p>
                  </div>
              ...
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl space-y-3">
                ...
                <div className="space-y-2">
                  {familyMembers.map((member) => (
                    <div
                      key={member.id}
                      className="text-xs border-l-2 border-[#0ea5e9] pl-3 py-1"
                    >
                      <p className="text-white font-medium">
                        {member.fullName}
                      </p>
                      <p className="text-gray-400">
                        {member.relationship} • {member.medicalCondition}
                      </p>
                    </div>
                  ))}
                </div>
