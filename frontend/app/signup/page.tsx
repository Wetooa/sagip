    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="rounded-[3rem] border-[12px] border-[#1a1a1a] shadow-2xl overflow-hidden bg-black">
          ...
          {/* Screen Content */}
          <div
            className="bg-gradient-to-br from-[#0f172a] via-[#1a1f35] to-[#111827] overflow-y-auto relative"
            style={{ height: "844px" }}
          >
            ...
            {/* Content Area */}
            <div className="pt-6 pb-6 px-6 overflow-y-auto scrollbar-hide">
              {/* Header */}
              <div className="mb-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <p className="text-center text-sm text-gray-400">
                  ...
                  <Link
                    href="/login"
                    className="text-[#ff6b6b] hover:text-[#ff8e72] font-semibold transition-colors"
                  >
                    Login here
                  </Link>
                </p>
